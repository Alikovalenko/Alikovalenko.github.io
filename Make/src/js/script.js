...
function Search_site_all() {
  ...
  'contacteng.html','contactdeu.html','contactrus.html','newseng.html','newsdeu.html','newsrus.html']; 
...
function ENG() {
  const urleng = `indexeng.html`;
  const url = `index.html`;
  const urldeu = `indexdeu.html`;
  const urlrus = `indexrus.html`;
...
function UKR() {
  const urlukr = `index.html`;
  const urldeu = `indexdeu.html`;
  const urleng = `indexdeu.html`;
  const urlrus = `indexrus.html`;
  window.close(urleng, '_blank');
  window.close(urldeu, '_blank');
  window.close(urlrus, '_blank');
  window.open(urlukr, '_blank');   
}
function DEU() {
  const urlukr = `index.html`;
  const urldeu = `indexdeu.html`;
