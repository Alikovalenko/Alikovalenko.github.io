...
window.addEventListener('DOMContentLoaded', () => {
  ...
  function ENG() {
          ...
          let title_news1_ukr = document.getElementById('title_news1_ukr');
          let title3_slot1_ukr = document.getElementById('title3_slot1_ukr');
          let title_news1_eng = document.getElementById('title_news1_eng');
          let title3_slot1_eng = document.getElementById('title3_slot1_eng');
          let title_news1_deu = document.getElementById('title_news1_deu');
          let title3_slot1_deu = document.getElementById('title3_slot1_deu');
          let title_news1_rus = document.getElementById('title_news1_rus');
          let title3_slot1_rus = document.getElementById('title3_slot1_rus');
          title_news1_ukr.style.display='none'; 
          title3_slot1_ukr.style.display='none'; 
          title_news1_eng.style.display='block';
          title3_slot1_eng.style.display='block';
          title_news1_deu.style.display='none';
          title3_slot1_deu.style.display='none'; 
          title_news1_rus.style.display='none';
          title3_slot1_rus.style.display='none';
...
function UKR() {
    ...
    let title_news1_rus = document.getElementById('title_news1_rus');
    let title3_slot1_rus = document.getElementById('title3_slot1_rus');
    title_news1_ukr.style.display='block'; 
    title3_slot1_ukr.style.display='block'; 
    title_news1_eng.style.display='none';
    title3_slot1_eng.style.display='none';
    title_news1_deu.style.display='none';
    title3_slot1_deu.style.display='none'; 
    title_news1_rus.style.display='none';
    title3_slot1_rus.style.display='none';
...
function DEU() {
  ...
  title_news1_eng.style.display='none';
  title3_slot1_eng.style.display='none';
  title_news1_deu.style.display='block';
  title3_slot1_deu.style.display='block'; 
  title_news1_rus.style.display='none';
  title3_slot1_rus.style.display='none';
  eng.style.display='none';
  ukr.style.display='none';
...
function RUS() {
  ...
  title_news1_deu.style.display='none';
  title3_slot1_deu.style.display='none'; 
  title_news1_rus.style.display='block';
  title3_slot1_rus.style.display='block';
  eng.style.display='none';
  ukr.style.display='none';
