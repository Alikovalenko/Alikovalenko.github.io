var slider = tns({
  ...
  function Search_site_all() {
    ...
    function ENG() {
        const urleng = `reviewen.html`;
        const urlrus = `reviewrus.html`;
        const urldeu = `reviewdeu.html`;
        const url = `review.html`;
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Save review to localStorage and display it
    if (form) {
